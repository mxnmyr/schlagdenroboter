/*
 * NFC Reader für Arduino Nano + RFID-RC522
 ...
 * 
 * Verbindungen MFRC522 -> Arduino Nano:
 * ----------------------------------------
 * SDA/SS   -> Pin D10
 * SCK      -> Pin D13
 * MOSI     -> Pin D11
...
// LED-Pin (optional, für visuelle Bestätigung)
#define LED_PIN         LED_BUILTIN  // Integrierte LED auf Pin 13
...
void setup() {
  ...
  Serial.println(F("  Arduino Nano + MFRC522"));
  Serial.println(F("========================================"));
  Serial.println();
